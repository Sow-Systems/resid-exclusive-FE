  ...
  return (
    <div className="flex h-full p-3">
      <div className="flex flex-col w-full gap-2 2xl:gap-3">
        <div className="flex flex-row justify-between gap-2 2xl:gap-5">
          <Card className="w-full h-32 2xl:h-40">
            <div className="flex flex-row p-5 2xl:p-4 h-full">
              <div className="flex flex-col justify-around">
                <p className="text-xs 2xl:text-sm font-medium mb-4 2xl:mb-7 mr-4">
          ...
          <Card className="w-full">
            ...
            <div className="flex w-full overflow-y-auto">
              <table className="border-collapse w-full ml-3 mr-3">
                <thead className="text-[#64748B] text-xs 2xl:text-sm font-light text-left">
                  <tr>
                    <th
                ...
                <tbody>
                  {sortedDueAccountsFirstTable.map((conta) => (
                    <tr
                      key={conta.id}
                      className="text-left text-[#191D23] font-normal text-xs 2xl:text-sm whitespace-nowrap"
                    >
      ...
      <div className="flex flex-col gap-3 pl-3 2xl:pl-5">
        <div>
          <Card className="w-60 2xl:w-72 h-80 flex p-3 2xl:pl-4">
        ...
        <div className="h-screen pb-2">
          <Card className="flex p-3 2xl:pl-4 min-h-[610px] max-h-[610px]">
            <p className="mb-5 border-b border-black p-2 pb-3 font-bold text-base w-full text-center">
